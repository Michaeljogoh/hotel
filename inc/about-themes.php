...
<div class="gt-right">			
        <div>				
            <a href="<?php echo esc_url( HOTEL_CENTER_LITE_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'hotel-center-lite'); ?></a> | 
            <a href="<?php echo esc_url( HOTEL_CENTER_LITE_PROTHEME_URL ); ?>" target="_blank"><?php esc_html_e('Purchase Pro', 'hotel-center-lite'); ?></a> | 
            <a href="<?php echo esc_url( HOTEL_CENTER_LITE_THEME_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'hotel-center-lite'); ?></a>
        </div>		
</div><!-- .gt-right-->
<div class="clear"></div>
</div><!-- .wrap-GT -->
